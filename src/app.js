...
const app = express(); // app containes all functions and usibility of express
...
const partial_path = path.join(__dirname,"../templates/partials"); // declaring path to partials folder
...
hbs.registerPartials(partial_path); //telling our program to include partials folder 
    ...
    try{
            ...
            if(password===cpassword){  // validating if passwords match or not...
               ...
               res.status(201).render("index");  //after successful request save the data and render the index page again..
                ...
                res.send("passwords do not match"); // if passwords do not match then send a error message..
            }
